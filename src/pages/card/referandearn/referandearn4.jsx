...
import bulletGift from "../../../assets/bike.jpg";
    ...
    <div className="bg-gray-200 rounded-[15px] mt-6 p-4 md:p-8 md:w-full mx-auto">
      <div className="flex justify-center mb-6">
        <img
          src={bulletGift}
          alt="bulletGift"
          className="md:h-[300px] md:w-[600px] h-[150px] w-[300px] rounded-[15px]"
        />
      </div>
      ...
      <p className="text-center font-normal text-[22px] mb-6">
        Invite 800 friends to join our platform and get a chance to win a Bullet
        Bike!
      </p>
